...
async function main() {
    ...
    const testReport =
        new TestReport("MF Default Amount Add To Cart Test");
    ...
    try {
        ...
        console.log("=================================");
        console.log("MF PURCHASE TEST STARTED");
        console.log("=================================");
        ...
        if (!cartDisplayed) {
            throw new Error("Mutual Funds Cart screen was not displayed.");
        }

        console.log("Mutual Funds Cart screen displayed.");
        ...
        if (!isOtpDisplayed) {
            throw new Error("OTP authorization screen was not displayed after Pay.");
        }

        console.log("OTP authorization screen displayed.");

        console.log("");
        console.log("=================================");
        console.log("MF DEFAULT AMOUNT ADD TO CART + PAY VALIDATION COMPLETED");
        console.log("=================================");
        ...
        console.log("");
        console.log("=================================");
        console.log("MF DEFAULT AMOUNT ADD TO CART TEST PASSED");
        console.log("=================================");
    ...
    // =========================================
        ...
        console.error("");
        console.error("=================================");
        console.error("MF DEFAULT AMOUNT ADD TO CART Test FAILED");
        console.error("=================================");
